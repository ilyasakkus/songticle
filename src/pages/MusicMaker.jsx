...
const MusicMaker = () => {
  ...
  const [tracks, setTracks] = useState([
    ...
    { id: 3, name: 'Hi-hat', pattern: Array(16).fill(false) },
    { id: 4, name: 'Clap', pattern: Array(16).fill(false) }
  ]);
  ...
  const togglePlay = async () => {
    ...
    toast(isPlaying ? "Playback stopped" : "Playback started");
  };
