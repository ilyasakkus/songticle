          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              {playlist.description && (
                <p className="text-base-content/70 pr-4 text-base sm:text-xl leading-relaxed">{playlist.description}</p>
              )}
              {playlist.content && (
                <div 
                  className="mt-6 pb-2 pr-4 prose prose-sm sm:prose-base max-w-none"
